...
document.addEventListener("DOMContentLoaded", async function() {
    ...
    var DownloadBTN = document.getElementById('downloadapp');
    DownloadBTN.addEventListener('click', function() {
        window.location.href = '/TeamViewers/Download';
    });

    var HomePage = document.getElementById('returnHome');
    ...
    const data = await readDatabase("SELECT * FROM marketplace");
    for (let i = 0; i < data.length; i++){
        $(document).ready(function() {
            $('.w-layout-vflex.flex-block-15').append(`
                <div class="w-layout-blockcontainer container-6 w-container" onclick="openProduct(${data[i].Product})">
                    <div class="w-layout-vflex flex-block-17">
                        <div><img src="${data[i].Gambar.split('‽')[0]}" loading="lazy" width="70px" height="173px" alt="" class="image-6" /></div>
                        <div class="w-layout-vflex flex-block-19">
                            <div class="div-block">
                                <h1 class="heading-8">${data[i].Title}</h1>
                                <div class="text-block-2">Rp ${Number(data[i].Harga).toLocaleString()}</div>
                            </div>
                            <div class="div-block-2">
                                <div class="w-layout-hflex flex-block-20">
                                    <img src="https://assets-global.website-files.com/65ecb4b23af4c369d4ea3319/65f494d143eb5037a7d49777_store%20(1).png" loading="lazy" width="70" alt="" class="image-7" />
                                    <div class="text-block-3">${data[i].Channel}</div>
                                </div>
                                <div class="w-layout-hflex flex-block-20">
                                    <img src="https://assets-global.website-files.com/65ecb4b23af4c369d4ea3319/65f493fd91716018cf94480e_star.png" loading="lazy" width="70" sizes="(max-width: 767px) 16px, (max-width: 991px) 2vw, 16px" alt="" srcset="https://assets-global.website-files.com/65ecb4b23af4c369d4ea3319/65f493fd91716018cf94480e_star-p-500.png 500w, https://assets-global.website-files.com/65ecb4b23af4c369d4ea3319/65f493fd91716018cf94480e_star.png 512w" class="image-7" />
                                    <div class="text-block-3">${data[i].Review == "" ? "0" : ratings(data[i].Review)}</div>
                                </div>
                                <div class="w-layout-hflex flex-block-20">
                                    <img src="https://assets-global.website-files.com/65ecb4b23af4c369d4ea3319/65f494510a019f1d7818c95e_sold-out.png" loading="lazy" width="70" sizes="(max-width: 767px) 16px, (max-width: 991px) 2vw, 16px" alt="" srcset="https://assets-global.website-files.com/65ecb4b23af4c369d4ea3319/65f494510a019f1d7818c95e_sold-out-p-500.png 500w, https://assets-global.website-files.com/65ecb4b23af4c369d4ea3319/65f494510a019f1d7818c95e_sold-out.png 512w" class="image-7" />
                                    <div class="text-block-3">${data[i].Review == "" ? "0" : data[i].Review.split('‽').length}</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
function openProduct(productId) {
    window.location.href = `/TeamViewers/Marketplace/Product/${productId}`;
}
            ...
            var p = (function (l, h, _) {
                    ...
                    function k($, se) {
                        function M() {
                            var Ie = new J();
                            return (
                                y(Ie.init) && Ie.init.apply(Ie, arguments), Ie
                            );
                        }
                        function J() {}
                ...
                H = p(function (l) {
                    ...
                    function he() {
                        ...
                        (de = de.join(",")),
                            this.style !== de &&
                                ((this.style = de),
                                (this.el.style[D.transition.dom] = de));
                    }
                    function je(j, ne, de) {
                        var oe,
                            Oe,
                ...
                q = p(function (l) {
                    ...
                    (l.init = function (O, k, $, se) {
                        ...
                        $[2] && (M = $[2]),
                            ...
                            (this.unit =
                                se.unit || this.unit || ge.defaultUnit),
                            (this.angle =
                                se.angle || this.angle || ge.defaultAngle),
                    ...
                    e.forEach =
                        function (b, N, U) {
                            ...
                            if (g && b.forEach === g) b.forEach(N, U);
                                ...
                                for (
                                    var Y = e.keys(b), D = 0, Z = Y.length;
                                    D < Z;
                                    D++
                                )
                                    if (N.call(U, b[Y[D]], Y[D], b) === t)
                                        return;
                            return b;
                        });
            (e.map = e.collect =
...
` +
        ...
        var Li = window.jQuery,
            ...
            rn = {
                ...
                intro: function (e, t) {
                    t.__wf_intro ||
                        ((t.__wf_intro = !0),
                        Li(t).triggerHandler(Ye.types.INTRO));
                },
                outro: function (e, t) {
                    t.__wf_intro &&
                        ((t.__wf_intro = null),
                        Li(t).triggerHandler(Ye.types.OUTRO));
                },
            };
        Ye.triggers = {};
    ...
    var $i = c((h5, ic) => {
        ...
        ic.exports = function (e) {
            return (
                "Symbol(" + (e === void 0 ? "" : e) + ")_" + tb(++JT + eb, 36)
            );
        };
    });
    var Yi = c((v5, cc) => {
        ...
        Oc.f = Lb
            ...
            : function (t, r, n) {
                  ...
                  if ("get" in n || "set" in n)
                      throw Fb("Accessors not supported");
                ...
                (Xc(r) &&
                    (String(s).slice(0, 7) === "Symbol(" &&
                        (s =
                            ...
                            "]"),
                    (!aI(r, "name") || (cI && r.name !== s)) &&
                        kc(r, "name", s),
                    (u = fI(r)),
                    u.source ||
                        (u.source = dI.join(typeof s == "string" ? s : ""))),
                e === oI)
            ) {
                o ? (e[t] = r) : sI(t, r);
                return;
    ...
    var _l = c((j5, ml) => {
        ...
        ml.exports = r0
            ...
            : function (t, r) {
                  i0(t);
                  for (
                      var n = o0(r), i = a0(r), o = i.length, a = 0, s;
                      o > a;
    ...
    var Cp = c((qk, xp) => {
        ...
        function hC(e, t, r, n, i, o, a) {
            switch (r) {
                ...
                case pC:
                    return !(
                        e.byteLength != t.byteLength || !o(new Sp(e), new Sp(t))
                    );
                case iC:
                case oC:
                case uC:
    ...
    var xr = c((kk, Hp) => {
        var Xp = Bp(),
            ...
            MC = Xp(
                ...
                : function (e) {
                      return (
                          PC(e) && qC.call(e, "callee") && !FC.call(e, "callee")
                      );
                  };
        Hp.exports = MC;
    });
        ...
        function GN(e, t, r, n) {
            ...
            for (; ++i < o; ) {
                ...
                if (a && s[2]) {
                    ...
                    if (!(d === void 0 ? FN(g, f, MN | DN, n, p) : d))
                        return !1;
                }
            }
            return !0;
    ...
    var ya = c((jH, iv) => {
        ...
        iv.exports = function (t, r, n, i) {
            ...
            function s(u) {
                for (var f = 0, g = 1, p = Fr - 1; g !== p && o[g] <= u; ++g)
                    f += jn;
                --g;
    ...
    var Ia = c((ba) => {
        ...
        function vF(e) {
            let t,
                ...
                s =
                    (typeof gv[o] == "string" ? gv[o].toLowerCase() : null) ||
                    o;
            if (s.startsWith("#")) {
                let u = s.substring(1);
                u.length === 3
    ...
    function nD(e, t, r) {
        ...
        if (o === Jt) {
            let { config: a } = t;
            a.widthUnit === yt && n(e, et, ""),
                a.heightUnit === yt && n(e, tt, "");
        }
    ...
    function aD({ actionList: e, actionItemId: t, rawData: r }) {
        let { actionItemGroups: n, continuousParameterGroups: i } = e,
            ...
            a = (s) => (
                o.push(
                    (0, ei.mergeIn)(s, ["config"], { delay: 0, duration: 0 })
                ),
                s.id === t
            );
        return (
        ...
        iE = ce(() => {
            ...
            (kv = /px/),
                (LM = (e, t) =>
                    t.reduce(
                        (r, n) => (
                            r[n.type] == null && (r[n.type] = BM[n.type]), r
                        ),
                        e || {}
                    )),
                (PM = (e, t) =>
        ...
        (0, sr.default)(s, (p, d) => {
            ...
            HU(A, o.mediaQueryKeys) || t.dispatch(ns()),
                T.actionTypeId === Re.GENERAL_CONTINUOUS_ACTION &&
                    (Array.isArray(v.config) ? v.config : [v.config]).forEach(
                        (S) => {
                ...
                (T.actionTypeId === Re.GENERAL_START_ACTION ||
                    Es(T.actionTypeId)) &&
        ...
        if (u && u.useFirstGroupAsInitialState) {
            ...
            f.forEach((p) => {
                ...
                m.forEach((E) => {
                    ...
                    Ts({
                        destination: ms(
                            { element: E, actionItem: p, elementApi: we },
                            w
                        ),
                        immediate: !0,
                        store: e,
    ...
    function v_({ store: e }) {
        ...
        (0, sr.default)(t, (r) => {
            if (!r.continuous) {
                ...
                bs(r, e),
                    i && e.dispatch(or({ actionListId: n, isPlaying: !1 }));
            }
        });
    }
    function ar({
        ...
        (0, sr.default)(o, (u) => {
            ...
            if (u.actionListId === i && u.eventId === t && g) {
                ...
                bs(u, e),
                    u.verbose &&
                        e.dispatch(or({ actionListId: i, isPlaying: !1 }));
            }
        });
    }
    function $r({
            ...
            w.forEach((x, G) => {
                ...
                yi({
                    ...
                    let Y = C === G && U === 0,
                        ...
                        V = ms(
                            { element: N, actionItem: x, elementApi: we },
                            D
                        );
                    Ts({
                        store: e,
        ...
        if (mi(G, C.mediaQueryKey) && (n || r || i)) {
            ...
            if (i) {
                if (m) {
                    ...
                    E &&
                        !B &&
                        t.dispatch(or({ actionListId: T, isPlaying: !1 }));
                }
                bs(e, t);
            }
        }
    ...
    var T_ = c((ct) => {
        ...
        function bB(e) {
            __(),
                (0, Is.startEngine)({ store: Os, rawData: e, allowEvents: !0 });
        }
        function __() {
            (0, Is.stopEngine)(Os);
        }
            ...
            (S_.exports = function (e, t) {
                ...
                function v() {
                    (i = o && ur.env("design")),
                        ...
                        ur.scroll.off(m),
                        (p = []);
                    for (var E = document.links, w = 0; w < E.length; ++w)
                        T(E[w]);
                ...
                function A(E, w, S) {
                    ...
                    (S && C) ||
                        (!S && !C) ||
                        (S ? E.addClass(w) : E.removeClass(w));
                }
                return r;
            })
        );
        ...
        Ii.define(
            ...
            (x_.exports = function (e) {
                ...
                function A(P) {
                    return (
                        m.test(P.hash) &&
                        P.host + P.pathname === r.host + r.pathname
                    );
                }
                let E =
        ...
        Oi.define(
            ...
            (P_.exports = function (e, t) {
                ...
                function S(L, V) {
                    ...
                    var K =
                        F.form.attr("aria-label") ||
                        F.form.attr("data-name") ||
                        "Form";
                ...
                function C() {
                    ...
                    n.on(
                        ...
                        n.on(
                            ...
                            (ee) => {
                                e(
                                    `input[name="${ee.target.name}"]:not(${L})`
                                ).map((le, Rt) =>
                                    e(Rt).siblings(V).removeClass(H)
                                );
                                let z = e(ee.target);
                                z.hasClass("w-radio-input") ||
                                    z.siblings(V).addClass(H);
                            }
                        ),
                        re.forEach(([ee, z]) => {
                            n.on(
                ...
                function D(L, V) {
                    ...
                    function l(y) {
                        var O = y.responseJSON && y.responseJSON.msg,
                            k = Ai;
                        typeof O == "string" &&
                        O.indexOf("InvalidFileTypeError") === 0
                            ? (k = We)
                            : typeof O == "string" &&
                    ...
                    function I() {
                        var y =
                            (V.fileUploads && V.fileUploads.toArray()) || [];
...
Webflow.require("ix2").init({
    events: {
        "e-27": {
            ...
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187db4",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-28": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187da0",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-29": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187d93",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-31": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187d9c",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-32": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187db1",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-34": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187d90",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-35": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187dac",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-36": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187d98",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-37": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187da4",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-38": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187db7",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-39": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187da8",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-46": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187dba",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    useEventTarget: true,
                                    id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187d94",
                                },
                                xValue: 10,
                                xUnit: "px",
                                yUnit: "PX",
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    ...
                                    id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187d97",
                                },
                                value: "flex",
                            },
                        },
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                duration: 0,
                                target: {
                                    id: "65ecb4b23af4c369d4ea3320|34b8cbcc-c41f-7725-30f9-256adb187d91",
                                },
                                value: "flex",
                            },
                        },
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                duration: 0,
                                target: {
                                    id: "65ecb4b23af4c369d4ea3320|caa5fe1c-6b4c-4ed5-5da6-81ae1479767b",
                                },
                                value: 0,
                                unit: "",
                            },
                        },
                        {
                            ...
                            config: {
                                ...
                                duration: 0,
                                target: {
                                    id: "65ecb4b23af4c369d4ea3320|83445954-5768-915b-f389-c47aa3595de1",
                                },
                                value: 0,
                                unit: "",
                            },
                        },
                        {
                            ...
                            config: {
                                ...
                                duration: 0,
                                target: {
                                    id: "65ecb4b23af4c369d4ea3320|d372b409-92e1-648a-0d77-14fcf37ef5ca",
                                },
                                value: 0,
                                unit: "",
                            },
                        },
                        {
                            ...
                            config: {
                                ...
                                duration: 0,
                                target: {
                                    id: "65ecb4b23af4c369d4ea3320|2719f527-e787-097e-64d8-603a3eb175fc",
                                },
                                value: 0,
                                unit: "",
                            },
