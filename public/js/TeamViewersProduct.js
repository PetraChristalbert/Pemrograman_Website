async function readDatabase(query) {
    try {
        ...
        return data; // Assuming data is already in the expected format
    } catch (error) {
...
async function createPayment(product, price) {
    try {
        const response = await fetch("/php/midtrans.php", {
            method: "POST",
            headers: {
                "Content-Type": "application/x-www-form-urlencoded"
            },
...
document.addEventListener("DOMContentLoaded", async function() {
    ...
    const data = await readDatabase('SELECT Product, Status, ID, Channel, Title, Deskripsi, Gambar, Tipe, Harga, Review FROM marketplace WHERE Product = ' + productId);
    document.querySelector('.heading-7').textContent = data[0].Title;
    document.querySelector('.text-block-3.channel-youtube').textContent = data[0].Channel;
    document.querySelector('.text-block-3.rating-produk').textContent = data[0].Review == "" ? "0" : ratings(data[0].Review);
    document.querySelector('.text-block-3.jumlah-terjual').textContent = data[0].Review == "" ? "0" : data[0].Review.split('‽').length;
    document.querySelector('.heading-9.harga-produk').textContent = "Rp " + Number(data[0].Harga).toLocaleString();
    document.querySelector('.paragraph-5.deskripsi-produk').textContent = data[0].Deskripsi;

    const purchaseButton = document.querySelector('.button-2');
    purchaseButton.addEventListener('click', async function(event) {
        event.preventDefault();
        $paymentlink = await createPayment(data[0].Title, data[0].Harga);
...
async function displayDataInPopup(data) {
...
async function ratings(review) {
    let rating = [];
    let rate = review.split('‽');
    for (let i = 0; i < rate.length; i++) {
        rating.push(parseInt(rate[i].split('§')[1]));
    }
    return rating.reduce((total, num) => total + num, 0) / rating.length;
}
...
function getCurrentDateTime() {
    ...
    const month = (now.getMonth() + 1).toString().padStart(2, '0'); // Adding 1 to month because it's zero-based
...
async function StartPayment(Product, Price) {
    await displayDataInPopup(Product + Price);
    const url = await createPaymentLink(Product, Price);
    await displayDataInPopup(url);
            ...
            var p = (function (l, h, E) {
                    ...
                    function V(X, te) {
                        function P() {
                            var he = new z();
                            return (
                                C(he.init) && he.init.apply(he, arguments), he
                            );
                        }
                        function z() {}
                        ...
                        return (
                            ...
                            (P.open = function (he) {
                                if (
                                    ((K = {}),
                                    C(he)
                                        ? (K = he.call(P, Be, ae, P, X))
                                        : T(he) && (K = he),
                                    T(K))
                                )
                                    for (var ar in K)
                                        h.call(K, ar) && (Be[ar] = K[ar]);
                ...
                it = p(function (l) {
                    ...
                    function ae() {
                        ...
                        (ie = ie.join(",")),
                            this.style !== ie &&
                                ((this.style = ie),
                                (this.el.style[q.transition.dom] = ie));
                    }
                    function Be(B, Y, ie) {
                        var Q,
                            ve,
                ...
                j = p(function (l) {
                    ...
                    (l.init = function (A, V, X, te) {
                        ...
                        X[2] && (P = X[2]),
                            ...
                            (this.unit =
                                te.unit || this.unit || _e.defaultUnit),
                            (this.angle =
                                te.angle || this.angle || _e.defaultAngle),
                    ...
                    e.forEach =
                        function (_, N, D) {
                            ...
                            if (g && _.forEach === g) _.forEach(N, D);
                                ...
                                for (
                                    var H = e.keys(_), q = 0, k = H.length;
                                    q < k;
                                    q++
                                )
                                    if (N.call(D, _[H[q]], H[q], _) === t)
                                        return;
                            return _;
                        });
            (e.map = e.collect =
...
`);
                    ...
                    if (J) {
                        if (!L.test(J))
                            throw new Error(
                                "variable is not a bare identifier: " + J
                            );
                    } else
                        (H =
                            `with(obj||{}){
...
` +
        ...
        var Si = window.jQuery,
            ...
            Qr = {
                ...
                intro: function (e, t) {
                    t.__wf_intro ||
                        ((t.__wf_intro = !0),
                        Si(t).triggerHandler(He.types.INTRO));
                },
                outro: function (e, t) {
                    t.__wf_intro &&
                        ((t.__wf_intro = null),
                        Si(t).triggerHandler(He.types.OUTRO));
                },
            };
        He.triggers = {};
    ...
    var Hi = c((cU, tc) => {
        ...
        tc.exports = function (e) {
            return (
                "Symbol(" + (e === void 0 ? "" : e) + ")_" + $T(++KT + YT, 36)
            );
        };
    });
    var Wi = c((lU, ac) => {
        ...
        Tc.f = xI
            ...
            : function (t, r, n) {
                  ...
                  if ("get" in n || "set" in n)
                      throw RI("Accessors not supported");
                ...
                (Vc(r) &&
                    (String(s).slice(0, 7) === "Symbol(" &&
                        (s =
                            ...
                            "]"),
                    (!tb(r, "name") || (ib && r.name !== s)) &&
                        Bc(r, "name", s),
                    (u = ab(r)),
                    u.source ||
                        (u.source = sb.join(typeof s == "string" ? s : ""))),
                e === eb)
            ) {
                o ? (e[t] = r) : rb(t, r);
                return;
    ...
    var El = c((BU, vl) => {
        ...
        vl.exports = Qb
            ...
            : function (t, r) {
                  Jb(t);
                  for (
                      var n = e0(r), i = t0(r), o = i.length, a = 0, s;
                      o > a;
    ...
    var Ir = c((DH, Up) => {
        var Vp = Gp(),
            ...
            NC = Vp(
                ...
                : function (e) {
                      return (
                          wC(e) && CC.call(e, "callee") && !RC.call(e, "callee")
                      );
                  };
        Up.exports = NC;
    });
        ...
        function PN(e, t, r, n) {
            ...
            for (; ++i < o; ) {
                ...
                if (a && s[2]) {
                    ...
                    if (!(d === void 0 ? RN(g, f, NN | LN, n, p) : d))
                        return !1;
                }
            }
            return !0;
    ...
    var da = c((BW, tv) => {
        ...
        tv.exports = function (t, r, n, i) {
            ...
            function s(u) {
                for (var f = 0, g = 1, p = Cr - 1; g !== p && o[g] <= u; ++g)
                    f += Un;
                --g;
    ...
    function ov(e, t, r, n, i) {
        let o =
            r === Lq
                ? (0, Ht.getIn)(i, ["config", "target", "objectId"])
                : null;
    ...
    var Ea = c((va) => {
        ...
        function fF(e) {
            let t,
                ...
                s =
                    (typeof fv[o] == "string" ? fv[o].toLowerCase() : null) ||
                    o;
            if (s.startsWith("#")) {
                let u = s.substring(1);
                u.length === 3
    ...
    function ZM(e, t, r) {
        ...
        if (o === Kt) {
            let { config: a } = t;
            a.widthUnit === pt && n(e, ze, ""),
                a.heightUnit === pt && n(e, Ke, "");
        }
    ...
    function tD({ actionList: e, actionItemId: t, rawData: r }) {
        let { actionItemGroups: n, continuousParameterGroups: i } = e,
            ...
            a = (s) => (
                o.push(
                    (0, Yn.mergeIn)(s, ["config"], { delay: 0, duration: 0 })
                ),
                s.id === t
            );
        return (
        ...
        tE = re(() => {
            ...
            (Bv = /px/),
                (xM = (e, t) =>
                    t.reduce(
                        (r, n) => (
                            r[n.type] == null && (r[n.type] = MM[n.type]), r
                        ),
                        e || {}
                    )),
                (wM = (e, t) =>
    ...
    function Ja({ id: e, selector: t }) {
        if (e) {
            ...
            if (e.indexOf(Ty) !== -1) {
                ...
                if (
                    ((r = n[1]),
                    i !== document.documentElement.getAttribute(by))
                )
                    return null;
            }
        ...
        t && e.dispatch(Xa(t)),
            i.active ||
                ...
                r &&
                    (r5(e),
                    QB(),
                    e.getState().ixSession.hasDefinedMediaQueries && kB(e)),
                e.dispatch(Wa()),
                ZB(e, n));
    }
    function QB() {
    ...
    function u5({ logic: e, store: t, events: r }) {
        ...
        (0, rr.default)(s, (p, d) => {
            ...
            VB(b, o.mediaQueryKeys) || t.dispatch(Qa()),
                ...
                (O.actionTypeId === be.GENERAL_START_ACTION ||
                    fs(O.actionTypeId)) &&
        ...
        if (u && u.useFirstGroupAsInitialState) {
            ...
            f.forEach((p) => {
                ...
                y.forEach((v) => {
                    ...
                    hs({
                        destination: ps(
                            { element: v, actionItem: p, elementApi: me },
                            S
                        ),
                        immediate: !0,
                        store: e,
            ...
            S.forEach((x, F) => {
                ...
                pi({
                    ...
                    let H = w === F && D === 0,
                        ...
                        xe = ps(
                            { element: N, actionItem: x, elementApi: me },
                            q
                        );
                    hs({
                        store: e,
        ...
        if (gi(F, w.mediaQueryKey) && (n || r || i)) {
            ...
            if (i) {
                if (y) {
                    ...
                    v &&
                        !M &&
                        t.dispatch(er({ actionListId: O, isPlaying: !1 }));
                }
                vs(e, t);
            }
        }
    ...
    var y_ = c((nt) => {
        ...
        function E5(e) {
            E_(),
                (0, Es.startEngine)({ store: ys, rawData: e, allowEvents: !0 });
        }
        function E_() {
            (0, Es.stopEngine)(ys);
        }
            ...
            (b_.exports = function (e, t) {
                ...
                function m() {
                    (i = o && nr.env("design")),
                        ...
                        nr.scroll.off(y),
                        (p = []);
                    for (var v = document.links, S = 0; S < v.length; ++S)
                        O(v[S]);
                ...
                function O(v) {
                    if (!v.getAttribute("hreflang")) {
                        var S =
                            (i && v.getAttribute("href-disabled")) ||
                            v.getAttribute("href");
                ...
                function b(v, S, I) {
                    ...
                    (I && w) ||
                        (!I && !w) ||
                        (I ? v.addClass(S) : v.removeClass(S));
                }
                return r;
            })
        );
                ...
                function M(L, _, N) {
                    ...
                    return (
                        a.add(L).each(function (q, k) {
                            var H = parseFloat(
                                k.getAttribute("data-scroll-time")
                            );
                            !isNaN(H) && H >= 0 && (D = H);
                        }),
...
Webflow.require("ix2").init({
    events: {
        e: {
            ...
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2b00",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-2": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2b18",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-3": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2af7",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-4": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2b0c",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-6": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2b15",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-7": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2afc",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-10": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2b04",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-11": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2b10",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-13": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2b1b",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-14": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2af4",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-18": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2b1e",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-22": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2b08",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-27": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea24f",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-28": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea267",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-29": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea246",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-30": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea25b",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-32": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea264",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-33": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea24b",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-36": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea253",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-37": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea25f",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-39": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea26a",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-40": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea243",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-44": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea26d",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-48": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea257",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-55": {
            ...
            target: {
                id: "65fc592e25023f3e5548c71d|790cd01d-7ab6-9bdf-2bd9-ca947d4110ca",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
            },
            targets: [
        ...
        "e-57": {
            ...
            target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "65fc592e25023f3e5548c71d|0bab010c-d69e-2468-5197-e8a6a71f337e",
            },
            targets: [],
            config: {
                loop: false,
        ...
        "e-59": {
            ...
            target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "65fc592e25023f3e5548c71d|53a72c0e-b62b-ee8e-c38b-c974e76501a1",
            },
            targets: [],
            config: {
                loop: false,
    ...
    actionLists: {
        "a-6": {
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    useEventTarget: true,
                                    id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2af8",
                                },
                                xValue: 0,
                                xUnit: "px",
                                yUnit: "PX",
            ...
            createdOn: 1709982541659,
        },
        "a-5": {
            id: "a-5",
            title: "Hover_Option_Come",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    ...
                                    id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2afb",
                                },
                                value: "none",
                            },
                        },
        ...
        a: {
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                duration: 0,
                                target: {
                                    id: "65fc592e25023f3e5548c71d|7cff16e4-27b3-dfa5-62a1-1fc7736a2af5",
                                },
                                value: "flex",
                            },
                        },
            ...
            useFirstGroupAsInitialState: false,
            createdOn: 1709981447896,
        },
        "a-3": {
            id: "a-3",
            title: "Open_Tutorial_List",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    useEventTarget: true,
                                    id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea247",
                                },
                                xValue: 0,
                                xUnit: "px",
                                yUnit: "PX",
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    useEventTarget: "SIBLINGS",
                                    id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea24a",
                                },
                                value: "none",
                            },
                        },
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                duration: 0,
                                target: {
                                    id: "65fc592e25023f3e5548c71d|a736ad7e-0f37-565e-20f7-4084e48ea244",
                                },
                                value: "flex",
                            },
                        },
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                value: "none",
                                target: {
                                    id: "65fc592e25023f3e5548c71d|959ee8c1-709a-95e0-b4d3-24b4e291d1d0",
                                },
                            },
                        },
                    ],
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                value: "none",
                                target: {
                                    id: "65fc592e25023f3e5548c71d|50a235fd-d4e7-b892-a94f-1208734faf86",
                                },
                            },
                        },
                    ],
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    ...
                                    id: "65fc592e25023f3e5548c71d|6a1b5d32-b214-6e64-adb4-129c91809a6b",
                                },
                                value: 1,
                                unit: "",
                            },
